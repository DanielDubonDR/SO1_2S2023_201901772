...
function Home() {
  ...
  const repositorio = () => {
    window.open('https://github.com/DanielDubonDR/SO1_2S2023_201901772/tree/main/Proyectos/Proyecto_2', '_blank');
  }
  ...
  return (
    <>
      <div className="bg-general">
          <br/><br/>
          <h1 className="lobster text-white title-home pt-5">Sistema de Registro de Notas</h1>
